...
const ViewProfileCard = () => {
  ...
  const g_viewProfileState: any = useSelector(
      ...
      >
        ...
        <Box>
          <List>
            ...
            <ListItem className="EmailAddressStyle">
              <ListItemAvatar>
              ...
              >
                Email Address
                {
                  ...
                  <Typography sx={{ fontSize: "14px" }}>
                    {g_viewProfileState?.userdetails?.emailaddress}
                  </Typography>
                }
              </Typography>
            </ListItem>
            ...
            <ListItem className="twoeightpixel">
              ...
              <ListItemText
                ...
                sx={{ marginLeft: "20px", color: "#3c3e42",fontSize:"14px"}}
              />
            </ListItem>
