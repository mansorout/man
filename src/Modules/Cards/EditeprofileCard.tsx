    ...
    <>
      <div style={{
        ...
        <Grid container spacing={3}  >
          ...
          <Grid item xs={12} sm={6} sx={{ lineHeight: "2.5rem" }}>
            ...
            >
              <Stack m={2} spacing={6}>
                ...
                <TextField
                  ...
                  fullWidth
                  id='First Name'
                  sx={{ color: "#f9f9f9", fontSize: "15px", fontWeight: "normal" }}
                >
                ...
                <TextField label="Middle Name"
                  ...
                  sx={{ color: "#f9f9f9", fontSize: "15px", fontWeight: "normal", marginTop: "10px" }} >
                  ...
                  <div style={{ position: "relative", top: "-46px" }}>
                    <FormControl sx={{ width: "198px" }}>
                      <InputLabel
                        ...
                        sx={{ color: "#3c3e42", fontSize: "15px", fontWeight: "normal" }}>pincode</InputLabel>
                    ...
                    <FormControl sx={{ width: "198px" }}>
                      <InputLabel
                        id="demo-simple-select-label"
                        sx={{ color: "#3c3e42", fontSize: "15px", fontWeight: "normal" }}>country</InputLabel>
