...
import { AppBar, Divider, Menu, MenuItem, Theme, useTheme } from '@mui/material';
            ...
            <Modal open={props.open} >
                <Box style={{
                    ...
                    <Grid container style={{ backgroundColor: "white", display: "flex" }}>
                        ...
                        <b style={{ textAlign: "center" ,paddingLeft: "25%",}}>Help us know you better.</b>
                        <Typography textAlign="center"  sx={{ fontSize: "14px",paddingLeft: "9%", color:"#7b7b9d" }}>  
               ...
               <TextField
                ...
                />
                    ...
                    <Box>
                        ...
                        sx={{ padding: " 16px 140px 19px", backgroundColor: "#23db7b" }}>
