...
function InvestNowScreen(props: IProps) {
  ...
  const handleChangeInvest=(e:any)=>{
        ...
        <Grid container spacing={0} sx={{ height: "100vh" }}>
          ...
          <Grid container xs={13} sm={11} md={10}>
            ...
            >
              ...
              <Box sx={{ width: "100%" }}>
                <Grid
                  sx={{ padding: "0px 9px !important" }}
                  container
                  rowSpacing={{ xs: 1, sm: 2, md: 3 }}
                  columnSpacing={{ xs: 1, sm: 2, md: 3 }}
                  className="investWholeStyle"
                >
                    ...
                    >
                      <CardContent>
                            ...
                            <Box sx={{ marginLeft: "11px" }}>
                              ...
                              <img
                                ...
                                style={{
                                  ...
                                  fontSize: "12px",
                                  boxShadow:
                                    "0 3px 6px 0 rgba(75, 123, 236, 0.12)",
                                  backgroundColor: "#6c63ff",
                                }}
                              ></img>
                            </Box>
                            <Box sx={{ marginLeft: "-11px" }}>10Y</Box>{" "}
                            <Box>15Y</Box> <Box>20Y</Box>
                          </Box>
                        </Typography>
                        ...
                        <Grid
                          container
                          spacing={1}
                          sx={{ paddingTop: "15px", paddingLeft: "2%" }}
                        >
                          <Grid
                            item
                            xs={6}
                        ...
                        >
                          ...
                          <Grid
                            item
                            xs={3}
                            sx={{ paddingTop: "9px", paddingLeft: "14px" }}
                            className="NoLockinperiod"
                          >
                            <Typography
                              sx={{ fontSize: "10px", color: "#7b7b9d" }}
                            >
                              *No Lock-in Period
                            </Typography>
                          </Grid>
