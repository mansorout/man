...
import {
  ...
  fontSize: "16px",color: "#3c3e42"}} >Min. Investment:</Typography>
                      <Typography sx={{fontFamily: "Roboto",
  fontSize: "12px",color: "#7b7b9d",fontWeight: "500"}}>Monthly SIP</Typography>
                      <Typography sx={{fontFamily: "Roboto",
  fontSize: "14px",color: "#3c3e42",fontWeight: "500"}}>₹500</Typography>
          </Grid>
          <Grid item xs sx={{marginTop:"21px"}}>
            <Typography sx={{fontFamily: "Roboto",
  fontSize: "12px",color: "#7b7b9d",fontWeight: "500"}}>One-time Lumpsum</Typography>
            <Typography sx={{fontFamily: "Roboto",
  fontSize: "14px",color: "#3c3e42",fontWeight: "500"}}>₹5,000</Typography>
          </Grid>
        </Grid>
