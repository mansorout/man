...
import {
  ...
  setUserViewProfileDataAction,
  setloginDataOnSuccessAction,
    ...
    <div>
      ...
      <Box
        sx={{
          display: "block",
          opacity: { xs: "0", sm: "1" },
          pointerEvents: { xs: "none", sm: "initial" },
          ...
          position: "fixed",
          width: { sm: "10vw", md: "17vw" },
          zIndex: "11",
        }}
        className={`${toggleState ? classes.mobileMenu : ""}`}
      >
          ...
          <ListItem disablePadding>
            <ListItemButton
              ...
              sx={{
                ...
                background:
                  pathName == "/home" ? "rgba(0, 0, 0, 0.05)" : "transparent",
              }}
            >
              <ListItemIcon
                sx={{
              ...
              >
                <HomeIcon
                  sx={{ color: pathName == "/home" ? "#23db7b" : "black" }}
                />
              </ListItemIcon>
              <ListItemText
                primary="Home"
          ...
          <ListItem disablePadding sx={{ display: "block" }}>
            ...
            >
              ...
              >
                <Search
                  sx={{
                    color: pathName == "/explorefunds" ? "#23db7b" : "black",
                  }}
                />
              </ListItemIcon>
              <ListItemText
          ...
          >
            <ListItemButton
              ...
              sx={{
                ...
                background:
                  pathName == "/logout" ? "rgba(0, 0, 0, 0.05)" : "transparent",
                flexDirection: { sm: "column", md: "row" },
              }}
            >
              <ListItemIcon
              ...
              >
                <PowerSettingsNew
                  sx={{ color: pathName == "/logout" ? "#23db7b" : "black" }}
                />
              </ListItemIcon>
              <ListItemText
                primary="Logout"
