...
import { Box, Breadcrumbs, Grid, IconButton, InputBase, Link, Toolbar, Typography } from "@mui/material";
              ...
              <Box style={{ display: "flex", alignItems: 'start', justifyContent: "space-between", flexWrap: 'wrap' }}>
                <Box padding={2} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: 'wrap' }}>
                  <Box>
                    ...
                    <Typography style={{ fontSize: "18px", color: "#3c3e42", fontWeight: "500" }}>Choose Fund to Replace</Typography>
                    <Typography sx={{ fontSize: '12px', color: '#8787a2' }}>SIP Investment</Typography>
