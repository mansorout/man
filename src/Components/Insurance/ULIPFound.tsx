                ...
                sumAmount !== "" && member !== "" ?
                  (
                    ...
                    <Grid item xs={12} my={3}>
                      <Typography style={{color:"#3c3e42", fontWeight:"500", fontSize:"16px", cursor:"pointer"}}>{ULIPList.length} ULIP Plan Found</Typography>
                      <Typography style={{color:'#7b7b9d', fontSize:"14px"}}>One-time lumsum investment of <b>{sumAmount}</b></Typography>
                    </Grid>
                    <Grid item xs={12}>
                      {
                        ULIPList.map((item,index) => {
                          return(
                            <ULIPCard {...item} key={index}></ULIPCard>
                          )
                        })
                      }
                    </Grid>
