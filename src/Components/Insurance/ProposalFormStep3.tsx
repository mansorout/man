                    ...
                    <Grid container>
                        <Grid sx={{ marginBottom: '60px', backgroundColor: '#f9f9f9', height: { xs: "auto", sm: "inherit" }, padding: 2, boxSizing: "border-box", overflow: { sx: "auto", sm: "scroll", }, paddingLeft: { xs: "15px", sm: '105px !important', md: '245px !important' } }} item xs={12}>
                            ...
                            <div className="progressContainer">
                                <p style={{ color: '#f9f9f9' }}>STEP 3/4</p>
                            ...
                            <div style={{margin:'26px 32px'}}>
                                <p className='fotterText'>*Please reconfirm the above mentioned contact details.</p>
                                <p className='fotterText'>These will be used for all the future transactions made via SprintMoney. In case of any future edits to change it from your profile section. </p>
                            </div>
                        </Grid>
                    </Grid>
                </Box>
...
export default ProposalFormStep3