...
const ProposalForm = () => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100vh' }}>
                ...
                <Box sx={style.main}>
                    ...
                    <Grid container>
                        <Grid sx={{ marginBottom: '60px', backgroundColor: '#f9f9f9', height: { xs: "auto", sm: "inherit" }, padding: 2, boxSizing: "border-box", overflow: { sx: "auto", sm: "scroll", }, paddingLeft: { xs: "15px", sm: '105px !important', md: '245px !important' } }} item xs={12}>
                            ...
                            <div style={{ maxWidth: '487px', margin: '8px 32px' }}>
                                <Accordion >
                                    <AccordionSummary
                                    ...
                                    >
                                        <div style={{ display: 'flex', alignItems: 'center' }}>
                                            ...
                                            <img src={manicon} alt="" style={{ width: "32px", height: "32px" }} />
                                            <Typography>Me</Typography>
                                        </div>
                                    </AccordionSummary>
                                    <AccordionDetails>
                                        <ProposalFormCard handleChange={handleMeChange}
                                            fName={meData.fName}
                                            lName={meData.lName}
                                            occupation={meData.occupation}
                                            gender={meData.gender}
                                            heightFeet={meData.heightFeet}
                                            heightInch={meData.heightInch}
                            ...
                            <div style={{ maxWidth: '487px', margin: '8px 32px' }}>
                                <Accordion >
                                    ...
                                    <AccordionDetails>
                                        <ProposalFormCard handleChange={handleSpouseChange}
                                            fName={spouseData.fName}
                                            lName={spouseData.lName}
                                            occupation={spouseData.occupation}
                                            gender={spouseData.gender}
                                            heightFeet={spouseData.heightFeet}
                                            heightInch={spouseData.heightInch}
                                ...
                                <Accordion >
                                    ...
                                    >
                                        <div style={{ display: 'flex', alignItems: 'center' }}>
                                            ...
                                            <img src={manicon} alt="" style={{ width: "32px", height: "32px" }} />
                                            <Typography>Daughter</Typography>
                                        </div>
                                    </AccordionSummary>
                                    <AccordionDetails>
                                        <ProposalFormCard handleChange={handleDaughterChange}
                                            fName={daughterData.fName}
                                            lName={daughterData.lName}
                                            occupation={daughterData.occupation}
                                            heightFeet={daughterData.heightFeet}
                                            heightInch={daughterData.heightInch}
                                            weight={daughterData.weight} />
                                    </AccordionDetails>
                                </Accordion>
                            </div>
            ...
            <FooterWithBtn
                btnText='Continue'
                btnClick={() => { navigate('/proposalFormStep2')}}
            />
        </div >
    )
}
