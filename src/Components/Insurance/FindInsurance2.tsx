...
const FindInsurance2 = () => {
  ...
  const [cities, setQuickCities] = useState<string[]>([
    "Mumbai",
    "Delhi",
    "Ahmedabad",
    "Pune",
    ...
    >
        ...
        <Box sx={style.main}>
          ...
          <Grid container>
            <Grid
              ...
              xs={12}
            >
              <div className="progressContainetwo">
                {" "}
                <div className="progressContainer">
                  <p style={{ color: "#f9f9f9" }}>STEP 2/2</p>
                  <p style={{ color: "#ffffff" }}>
                    Help us with the date of birth of members and their city of
                    residence
                  </p>
                  <Box width="100%">
              ...
              >
                <div className="genderSelect">
                  ...
                  <p className="purpleText">
                    Date of Birth of Selected Members
                  </p>
                  <TextField
                    label="Enter city name or pincode"
                    name="addressline1"
                    value={addressLine1}
                    onChange={(e) => {
                  ...
                  <Box sx={{ paddingTop: "20px" }}>
                    ...
                    >
                      Choose from the popular cities
                    </span>
      ...
      <FooterWithBtn
        ...
        btnClick={() => {
          ...
          setTimeout(() => {
            setOpenModal(false);
            navigate("/healthInsurance/letsfindrightinsurance");
          }, 2000);
        }}
