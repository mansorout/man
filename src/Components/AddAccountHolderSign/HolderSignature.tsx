      ...
      <Box style={{width: "100vw"}} ref={refContainer}>
        ...
        <Box  sx={style.main}>
          <Grid container spacing={0} sx={{height:"100vh", overflow:"hidden"}}>
            ...
            <Box sx={style.signatureContainer}>
                 <Typography className='mediumButtonText'>Add Account Holder Signature</Typography>
                 <Box style={style.dividerBox}>
                 
                 </Box>
                      <Box>
                        <Typography sx={style.drawHere}>Draw Here</Typography>
                         </Box>
